        ...
        <div class="custom-scrollbar max-h-full flex-1 space-y-6 overflow-auto p-5 xl:space-y-8 xl:p-6">
          <div class="max-w-[350px]">
            <div class="flex items-start gap-4">
              ...
              <div>
                <div class="rounded-lg rounded-tl-sm bg-gray-100 px-3 py-2">
          ...
          <div class="ml-auto max-w-[350px] text-right">
            <div class="ml-auto max-w-max rounded-lg rounded-tr-sm bg-blue-400 px-3 py-2">
          ...
          <div class="ml-auto max-w-[350px] text-right">
            ...
            <div class="ml-auto mt-2 max-w-max rounded-lg rounded-tr-sm bg-blue-400 px-3 py-2">
              <p class="text-sm text-white">
